...
//?a-Kullanıcıların yapılacak title'ini ve completed durumunu listeleyelim

// userTodos.forEach((user) => console.log(`${user.title} : ${user.completed}`));
...
//?c-Birinci kullanicinin sadece bitirdigi isleri listeyelim. //hem kullanici id sini hem toto su completed olanlari filtreleyip yazdirmaliyiz.

// userTodos
//   .filter((user1) => user1.userId === 1 && user1.completed === true)
//   .forEach((user1) => console.log(`${user1.title} : ${user1.completed}`));

//?d-Kullanicinin girdigi ID ye sahip kisilerin bitirdigi isleri listeleyelim.

// const userIdP = +prompt(`Please enter your user id:`);

// userTodos
//   .filter((user) => user.userId === userIdP && user.completed === true)
...
//?a- Ürün ve fiyatlari listeleyelim.

// products.forEach((product) =>
//   console.log(`${product.title}: ${product.price}`)
// );

//?b- Ilk ürünün title, description, price ve category bilgilerini listeleyelim.
...
//   .forEach((product) => console.log(`${product.title}: ${product.price}`));

///destructuring yöntemiyle:
// products
//   .filter((product) => product.category === "laptops")
//   .forEach(({ title, price }) => {
...
// productsNew = products.filter(
//   (product) => product.category !== "home-decoration"
// );
// console.log(productsNew);

// //?e- Kullanicinin sectigi ürünü (id si girilen ürünü) silelim.

// const userChoice = +prompt(`Lütfen ürün id si giriniz:`);
// const newList = products.filter((product) => product.id !== userChoice);
// console.log(newList);

//?f- Yeni bir ürün ekleyelim

// products.push({
//   id: products.length+1,
//   title: "Antique Vase",
//   description: "Attractive Design DurablePremium Quality",
//   price: 30,
//   discountPercentage: 2.92,
//   rating: 4.92,
//   stock: 50,
...
//?g- Rest operatörünü kullanarak fiyatlari indirimli fiyatlarla güncelleyelim.
...
//toFixed her zaman string e cevirir. Bu nedenle islem sonucunu number a cevirmek iyi olacaktir.

//?h- Her kategoride kac ürün oldugunu gösterelim.
