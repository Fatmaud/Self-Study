...
const printScreen = (countries) => {
  ...
  <li class="list-group-item"><i class="fa-solid fa-landmark"></i> ${
    country.capital
  }</li>
  <li class="list-group-item"><i class="fa-solid fa-comment"></i> ${Object.values(
    country.languages
  )}</li>
  <li class="list-group-item"><i class="fa-solid fa-money-bill-wave"></i> ${
