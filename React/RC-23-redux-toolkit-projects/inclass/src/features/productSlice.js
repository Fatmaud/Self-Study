  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(getProductsData.fulfilled, (state, { payload }) => {
        state.loading = false;
        state.productsData = payload; // getProductsData fonksiyonundan return edilen veriyi alir payload.Unterrichtsstunden übrig
        11 Juli
        Verfallsdatum
        12 €
        Bonus
        Der Unterricht hat begonnen!
        Schüler:in ist online
        18 Apr., 17:30
        Numan Mete und Jodi
        
        1
        dashboard:practiceWidget__beforeClass__title
        ~ 5 min
        Aufwärmübungen
        2
        dashboard:practiceWidget__joinClass__title
        ~ 25 min
        Unterricht
        3
        dashboard:practiceWidget__afterClass__title
        ~ 10 min
        Spaßige Aktivitäten
        Üben Sie, was Sie gelernt haben, um Ihre Reise abzuschließen
